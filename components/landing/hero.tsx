      ...
      <div className="container relative">
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-2 lg:gap-10">
          ...
          <motion.div
            ...
            className="relative mx-auto h-[460px] w-full max-w-[420px]"
          >
            ...
            <motion.div
              className="absolute left-0 top-2 sm:-left-4"
              animate={{ y: [0, -10, 0] }}
            ...
            <motion.div
              className="absolute -top-6 right-2 flex flex-col items-end gap-1.5 sm:right-6"
              animate={{ y: [0, -8, 0] }}
            ...
            >
              ...
              <div className="rotate-[8deg] rounded-2xl border border-border/50 bg-card p-1.5 shadow-card">
                <Image
